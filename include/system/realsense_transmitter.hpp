...
//   [ColorPublisher]  color_buf -> H.264 -> rt/kist/camera/color/h264
//   [DepthPublisher]  depth_buf -> RVL   -> rt/kist/camera/depth/rvl
// Embed it in a device-side app (pass configs directly), or run it via the
// test_realsense_transmitter executable. Config parsing stays out of here.
