...
DepthEncodePublisher::DepthEncodePublisher() = default;
DepthEncodePublisher::~DepthEncodePublisher() { stop(); }

bool DepthEncodePublisher::start_channel(int domain_id, const std::string& network_interface,
    ...
    try {
        ...
        std::cerr << "[DepthEncodePublisher] DDS init failed on interface \""
...
void DepthEncodePublisher::publish(const RvlDepthFrame& frame) {
